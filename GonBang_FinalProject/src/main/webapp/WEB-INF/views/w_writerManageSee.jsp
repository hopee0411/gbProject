...
<body>
	...
	<section class="se" style="padding-top: 70px;">
		<div class="queContent">
			...
			<form class="table-secondary" method="post" action="w_AtPrivateInfoFix">
				<table class="table table-hover">
					<tbody class="table b">
						<tr class="table-secondary">
							<th scope="row"><font><font>공방이름</font></font></th>
							<td><font><font><input type="text"
										${writer_homedto.WH_GBNAME}></font></font></td>
						</tr>
						<tr class="table-secondary">
							...
							<td><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;"><input type="text"
										style="background-color: silver;" value="${writerdto.w_id}"
						...
						<tr class="table-secondary">
							...
							<td><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;"><input type="text"
										value="${writerdto.w_pwd}"></font></font></td>
						</tr>
						<tr class="table-secondary">
							<th scope="row"><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;">비밀번호확인</font></font></th>
							<td><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;"><input type="password"
										value="${writerdto.w_pwd}"></font></font></td>
						</tr>
						<tr class="table-secondary">
							<th scope="row"><font style="vertical-align: inherit;"><font
							...
							<td><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;"><input type="email"
										value="${writerdto.w_email}"></font></font></td>
						</tr>
						<tr class="table-secondary">
							<th scope="row"><font style="vertical-align: inherit;"><font
							...
							<td><font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;"><input type="text"
										value="${writerdto.w_companynum}"></font></font></td>
						</tr>
						<tr class="table-secondary">
							<th scope="row"><font style="vertical-align: inherit;"><font
